...
execute store result score @s monkeyhue.temp3 run data get storage btl:temp fusion[0].tag.btl.power
execute store result score @s monkeyhue.temp5 run data get storage btl:temp fusion[1].tag.btl.power
...
execute if score @s monkeyhue.time2 matches 6540006 run scoreboard players set @s monkeyhue.temp4 400000
execute if score @s monkeyhue.time2 matches 6540007 run scoreboard players set @s monkeyhue.temp4 600000
execute if score @s monkeyhue.time2 matches 6540008 run scoreboard players set @s monkeyhue.temp4 800000
