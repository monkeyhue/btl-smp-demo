...
summon item ~ ~1.2 ~ {Invulnerable:1b,PickupDelay:10,Tags:["btl.new"],Item:{id:"minecraft:egg",Count:1b,tag:{CustomModelData:6540001}},Motion:[0.0,0.2,0.0]}
...
data remove storage btl:temp fusion.item[0]
data remove storage btl:temp fusion.output
