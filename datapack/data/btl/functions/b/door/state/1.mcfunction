...
execute unless score @s monkeyhue.tempAI matches 1 run function btl:b/door/display/anim/open
...
execute if score @s monkeyhue.time1 matches 28 run function btl:battle/get_battle
