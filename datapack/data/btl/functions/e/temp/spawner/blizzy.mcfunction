execute if score @s monkeyhue.time1 matches 1 run spreadplayers ~ ~ 20 40 true @s
...
execute if score @s monkeyhue.time1 matches 2 run function btl:battle/ids/blue/summon/blizzy