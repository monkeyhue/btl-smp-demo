...
#// Hurt Time
execute on vehicle on vehicle if score @s monkeyhue.temp2 matches 1.. unless score @s monkeyhue.entity.hurtTime matches 0.. run scoreboard players set @s monkeyhue.entity.hurtTime 10
