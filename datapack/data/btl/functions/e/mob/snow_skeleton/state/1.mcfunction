...
execute if score @s monkeyhue.time2 matches 7 positioned ^0 ^1 ^-1 run function btl:e/mob/snow_skeleton/event/hurt

execute if score @s monkeyhue.time2 matches 14.. unless entity @p[distance=..2.75,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s monkeyhue.entity.AIState 0
execute if score @s monkeyhue.time2 matches 14.. on vehicle run effect clear @s slowness
