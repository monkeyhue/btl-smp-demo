...
#
#-------------------------------------------------------------#
execute unless score @s monkeyhue.tempAI matches 3 run data modify entity @s ArmorItems[3].tag.Damage set value 3
execute unless score @s monkeyhue.tempAI matches 3 facing entity @p feet run tp @s ~ ~ ~ ~180 0
execute unless score @s monkeyhue.tempAI matches 3 run scoreboard players set #btl.animLength monkeyhue.objmc1 21
...
execute if score @s monkeyhue.time2 matches 17.. run effect clear @s slowness