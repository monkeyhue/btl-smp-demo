...
execute if score @s btl.w.battleID matches -1..1 if score @s monkeyhue.time2 matches ..30 if entity @p[distance=..10,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s monkeyhue.entity.AIState 0
execute if score @s btl.w.battleID matches -1..1 if score @s monkeyhue.time2 matches 30.. if entity @p[distance=..10,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s monkeyhue.entity.AIState 2

execute if score @s btl.w.battleID matches 2..3 if score @s monkeyhue.time2 matches ..20 if entity @p[distance=..10,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s monkeyhue.entity.AIState 0
execute if score @s btl.w.battleID matches 2..3 if score @s monkeyhue.time2 matches 20.. if entity @p[distance=..10,gamemode=!creative,gamemode=!spectator] run scoreboard players set @s monkeyhue.entity.AIState 2