...
scoreboard players set @s[tag=btl.w.tier1] monkeyhue.entity.maxHealth 400
scoreboard players set @s[tag=btl.w.tier1] btl.w.battleID 1
execute if entity @s[tag=btl.w.tier1] at @a[distance=0..48] run scoreboard players add @s monkeyhue.entity.maxHealth 400
scoreboard players set @s[tag=btl.w.tier2] monkeyhue.entity.maxHealth 1200
scoreboard players set @s[tag=btl.w.tier2] btl.w.battleID 2
execute if entity @s[tag=btl.w.tier2] at @a[distance=0..48] run scoreboard players add @s monkeyhue.entity.maxHealth 1200
