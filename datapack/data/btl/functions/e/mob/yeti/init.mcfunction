...
scoreboard players set @s[tag=btl.w.tier1] monkeyhue.entity.maxHealth 250
scoreboard players set @s[tag=btl.w.tier1] btl.w.battleID 1
execute if entity @s[tag=btl.w.tier1] at @a[distance=0..48] run scoreboard players add @s monkeyhue.entity.maxHealth 250
