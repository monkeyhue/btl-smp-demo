...
execute if score @s monkeyhue.rng.out matches 20..44 run function btl:battle/ids/blue/summon/snow_skeleton
execute if score @s monkeyhue.rng.out matches 45..74 run summon item_display ~ ~ ~ {Tags:["btl.entity","btl.temp","btl.spawner.snow_zombie"]}
execute if score @s monkeyhue.rng.out matches 75..89 run function btl:battle/ids/blue/summon/snowfiend
