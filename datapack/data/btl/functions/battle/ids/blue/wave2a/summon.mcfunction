...
execute if score @s monkeyhue.rng.out matches 25..49 run function btl:battle/ids/blue/summon/snow_zombie
execute if score @s monkeyhue.rng.out matches 50..59 run function btl:battle/ids/blue/summon/blizzy
...
execute if score @s monkeyhue.rng.out matches 90..99 run summon item_display ~ ~ ~ {Tags:["btl.entity","btl.temp","btl.spawner.blizzy"]}
