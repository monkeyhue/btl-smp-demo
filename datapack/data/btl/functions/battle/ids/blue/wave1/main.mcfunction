...
execute unless score @s btl.w.tempID matches 1 run bossbar set btl:blue max 4000
...
execute if score @s btl.w.mobs matches ..3 if score @s monkeyhue.time1 matches 60.. run function btl:battle/ids/blue/wave1/summon
...
#--- Determine if win ---
execute if score @s btl.w.progress matches 4000.. run tag @s add btl.door.buffer