...
execute if data storage btl:temp {currentKill:"snow_zombie"} run scoreboard players add @s btl.w.progress 240
execute if data storage btl:temp {currentKill:"snow_skeleton"} run scoreboard players add @s btl.w.progress 200
execute if data storage btl:temp {currentKill:"chillager"} run scoreboard players add @s btl.w.progress 600
