...
#--- Mob randomization
execute if score @s monkeyhue.rng.out matches 0..29 run function btl:battle/ids/blue/summon/snow_skeleton
execute if score @s monkeyhue.rng.out matches 30..39 run function btl:battle/ids/blue/summon/chillager
execute if score @s monkeyhue.rng.out matches 40..89 run summon item_display ~ ~ ~ {Tags:["btl.entity","btl.temp","btl.spawner.snow_zombie"]}
