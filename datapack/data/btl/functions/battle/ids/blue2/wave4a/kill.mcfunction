...
execute if data storage btl:temp {currentKill:"snow_zombie"} run scoreboard players add @s btl.w.progress 40
execute if data storage btl:temp {currentKill:"snow_skeleton"} run scoreboard players add @s btl.w.progress 100
