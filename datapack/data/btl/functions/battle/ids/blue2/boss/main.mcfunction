...
execute unless score @s btl.w.tempID matches 5 run function btl:battle/ids/blue2/summon/yeti
execute unless score @s btl.w.tempID matches 5 run bossbar set btl:blue2 name {"translate": "battle.btl.wave.blue.boss"}
...
execute unless score @s btl.w.tempID matches 5 at @a[scores={btl.w.battleID=2}] run scoreboard players add @s btl.w.maxMobs 3
...
execute if score @s btl.w.mobs matches ..2 if score @s monkeyhue.time1 matches 200.. run function btl:battle/ids/blue2/boss/summon
execute if score @s monkeyhue.time1 matches 600.. if score @s btl.w.mobs < @s btl.w.maxMobs run function btl:battle/ids/blue2/boss/summon
scoreboard players add @s monkeyhue.time4 1
execute if score @s monkeyhue.time4 matches 1200.. run summon item_display ~ ~ ~ {Tags:["btl.entity","btl.temp","btl.spawner.snowfiend2"]}
...
execute if score @s monkeyhue.time3 matches 1 run stopsound @a[scores={btl.w.battleID=2}] music
execute if score @s monkeyhue.time3 matches 2 run playsound btl:music.blue.boss music @a[scores={btl.w.battleID=2}] ~ ~ ~ 1 1 1
